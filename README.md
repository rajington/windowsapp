...
- (void) bind(String key,              # case-insensitive single-character string; [complete list](https://github.com/sdegutis/windows.app/blob/master/Windows/SDKeyBindingTranslator.m#L148)
