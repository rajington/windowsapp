...
* Install options:
    ...
    * [Download Windows.app.zip](https://raw.github.com/sdegutis/windowsapp/master/Builds/Windows-LATEST.app.tar.gz), unzip, right-click app, choose "Open"
...
Therefore, this software is licensed under the MIT license (see [LICENSE](Licenses/LICENSE) file) with the additional clause that by using this software you agree not to put spiders or any other bugs under my pillow or blankets.
