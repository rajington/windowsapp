...
If you want to make your config files more modular, you can create the directory `~/.windowsapp` and use `require()` to load files within it. Auto-Reload will automatically reload your config file when anything inside this tree changes.
